...
def weather_api(city):
    ...
    headers = {'x-rapidapi-key': "48a9d3acbemsh51e3d6835ad11bep1a253cjsne66f78646111", 'x-rapidapi-host': "community-open-weather-map.p.rapidapi.com"}
...
def insta_api(username):
    ...
    headers = {'x-rapidapi-key': "48a9d3acbemsh51e3d6835ad11bep1a253cjsne66f78646111", 'x-rapidapi-host': "instagram40.p.rapidapi.com"}
...
def translate_api(payload):
    ...
    headers = {'content-type': "application/x-www-form-urlencoded", 'accept-encoding': "application/gzip", 'x-rapidapi-key': "48a9d3acbemsh51e3d6835ad11bep1a253cjsne66f78646111", 'x-rapidapi-host': "google-translate1.p.rapidapi.com"}
